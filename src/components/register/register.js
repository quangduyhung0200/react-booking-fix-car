...
class Register extends Component {
    ...
    handlRegister = async () => {
        ...
        let { address, gender, phone, userName, comfimPassword, email, password, avata } = this.state
        ...
        if (check === true) {
            let datainput = { address, gender, phone, userName, comfimPassword, email, password, avata }
    ...
    render() {
        ...
        console.log(this.state.isNewAccout)
        return (
            <>
