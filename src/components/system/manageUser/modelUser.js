...
class ModelUser extends Component {
    ...
    vetyfyData = () => {
        ...
        let { address, gender, phone, userName, comfimPassword, email, password, group } = this.state
        let re = /\S+@\S+\.\S+/;
        ...
        if (!password && this.props.action === 'CREATE') {
        ...
        if (!comfimPassword && this.props.action === 'CREATE') {
        ...
        if (password != comfimPassword && this.props.action === 'CREATE') {
    ...
    handlRegister = async () => {
        ...
        if (check === true) {
            if (this.props.action === 'CREATE') {
                ...
                let dataInput = { address, gender, phone, userName, comfimPassword, email, password, group, avata }
                    ...
                    <Modal.Body>
                        <div className='row'>
                            ...
                            {this.props.action === 'CREATE' ?
                                ...
                                <fieldset className=" col-12 col-sm-6 form-group" disabled>
