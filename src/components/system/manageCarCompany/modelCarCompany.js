...
import { createCarCompany, updateCarCompany } from '../../../services/staffService';
class ModelCarCompany extends Component {
    constructor(props) {
        super(props);
        this.state = {
    ...
    vetyfyData = () => {
        ...
        coppyStatea.isValidName = true
        coppyStatea.isValidDescription = true
        ...
        if (!description) {
            ...
            let coppyState = { ...coppyStatea }
            coppyState.isValidDescription = false
            this.setState({
                ...coppyState
            })
            return false
    ...
    handlRegister = async () => {
        ...
        let { name, description, avata } = this.state
        let check = this.vetyfyData()
        let id = this.props.dataModel.id
        if (check === true) {
            if (this.props.action === 'CREATE') {
                if (avata === '') {
            ...
            if (this.props.action === 'UPDATE') {
                ...
                let dataInput = { id, name, description, avata }
    ...
    render() {
        ...
        let { name, description,
            isValidName, isValidDescription, isNewAccout, } = this.state
            ...
            <div>
                ...
                >
                        ...
                        <div className='row'>
                            ...
                            <div className='col-12 col-sm-6 form-group'>
                                ...
                                <input onChange={(event) => this.handleOnchaneInput(event, 'description')} type='text'
                                    ...
                                    value={description} required></input>
                            </div>
                    ...
                    <Modal.Footer>
                        ...
                        <Button variant="primary" onClick={() => this.handlRegister()}>
                            Save Changes
                        </Button>
                    </Modal.Footer>
                </Modal>
...
export default ModelCarCompany;