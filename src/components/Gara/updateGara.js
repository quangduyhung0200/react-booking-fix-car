...
class UpadateGara extends Component {
    ...
    async componentDidUpdate(prevProps, prevState, snapshot) {
        if (prevState.garaId !== this.state.garaId) {
            ...
            if (dataGara.EC === 0 && data.EC === 0) {
                ...
                coppystate.id = this.context.user.account.id
                coppystate.contenMarkdown = dataGara.DT.contenMarkdown
                coppystate.contenHTML = dataGara.DT.contenHTML
                coppystate.descpistion = dataGara.DT.description

                coppystate.nameGara = dataGara.DT.nameGara
                coppystate.addressGara = dataGara.DT.address

                coppystate.selectProvint = { label: dataGara.DT.provindGaraData.name, value: dataGara.DT.provindGaraData.id }
                coppystate.avata = new Buffer(dataGara.DT.avata, 'base64').toString('binary');

                coppystate.previewimg = new Buffer(dataGara.DT.avata, 'base64').toString('binary');
                coppystate.phone = dataGara.DT.phone
                coppystate.garaId = id
    ...
    handleSveConTen = async () => {
        ...
        if (!this.state.contenHTML || !this.state.contenMarkdown || !this.state.descpistion
            ...
            || !this.state.selectProvint || !nameGara || !addressGara || !phone
        ) {
                ...
                <div className='register-container container'>
                    ...
                    <div className='register-body row'>
                        <div className=' col-12'>
                            <label className='fw-bold'>Thông tin giới thiệu</label>
                        ...
                        <div className='col-12 form-group'>
                            <label className='fw-bold'>Thuộc tỉnh thành</label>
                            <Select
                        ...
                        <div className='col-12 form-group'>
                            <label className='fw-bold'>Địa chỉ gara</label>
                            <input
                    ...
                    <button className='btn-save-conten btn-primary btn my-3' onClick={() => this.handleSveConTen()}>
                        Cập nhật </button>
